      ...
      - name: Build README
        run: |
...

          {
            ...
            echo "## About"
            echo ""
            echo "Professional UI test automation framework built from scratch."
            echo ""
            echo "- **Page Object Model** - separates test logic from page interactions"
            echo "- **Session recovery** - auto-recreates driver if browser crashes"
            echo "- **Failure screenshots** - saved automatically on every test failure"
            echo "- **Slow-motion execution** - colour-coded highlights for demos"
            echo "- **Headless support** - runs in CI with mvn test -Dheadless=true"
            echo "- **Auto README** - updates automatically on every push"
            echo ""
            echo "---"
            echo ""
            echo "## Tech Stack"
            ...
            echo "| GitHub Actions | - | CI and Auto README |"
            echo ""
            echo "---"
            echo ""
            echo "## How to Run"
            ...
            echo "| 4 | invalidLoginTest | Wrong user and pass | Error: do not match |"
            ...
            echo "| 7 | validLoginTest | Correct credentials | Inventory page loaded |"
            echo ""
            echo "---"
            echo ""
            echo "## Roadmap"
          ...
          echo "Done - README.md generated with ${TESTS} tests"
